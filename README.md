...
# 👋 Olá, eu sou Bernardo Cardoso

### 🔐 CyberSecurity | 🤖 Inteligência Artificial | 📊 Data Analysis
...
🎓 **Licenciado em Informática** pela UTFPR  
📚 **Pós-graduando** em Inteligência Artificial, Big Data, CyberSecurity e Cybercrimes  
👨‍🏫 **Professor de Tecnologia da Informação**  
💼 **Construindo portfólio híbrido** para atuar em IA e Segurança da Informação

Estou desenvolvendo projetos práticos que combinam **análise de dados**, **segurança ofensiva** e **inteligência artificial** para resolver problemas reais e demonstrar minhas habilidades técnicas.
